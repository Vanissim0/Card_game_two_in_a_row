...
export const startGame = (difficult) => {
    ...
    let clickable = true;
        ...
        const duplicateCardIcons = duplicateArray(cardsIcons);
        ...
        shuffle(duplicateCardIcons);

        // console.log(duplicateCardIcons);
        duplicateCardIcons.forEach(icon => gameTable.append(createGameCard('question-circle', icon)));
